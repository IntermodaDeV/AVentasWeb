...
import { ImprimirRecolocacionPedido } from 'components/RecolocacionPedido/ImprimirRecolocacionPedido';
...
export const RecolocacionPedido = (props) => {
    return (
        <Switch>
            ...
            <Route exact path={props.match.url + "/ImprimirRecolocacionPedido"} component={ImprimirRecolocacionPedido} />
        </Switch>
    );
}