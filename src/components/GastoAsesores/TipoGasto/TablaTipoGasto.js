        ...
        <div>
            {
                <div className="col">
                    ...
                    <div class="card-body text-center">
                        <h3 class="card-title">Tipos de Gasto</h3>
                        ...
                        <Table striped>
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ textAlign: 'center' }}>Diario</th>
                                    <th style={{ textAlign: 'center' }}>Estado</th>
                                    <th style={{ textAlign: 'center' }}>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                {props.TiposGastos.map(tip => (
                                    <tr key={tip.Id}>
                                        <td style={{ textAlign: 'center' }}>{tip.Empresa}</td>
                                        <td style={{ textAlign: 'center' }}>{tip.Nombre}</td>
                                        <td style={{ textAlign: 'center' }}>{tip.Diario}</td>
                                        ...
                                        <td style={{ textAlign: 'center' }}>
                                            ...
                                            <Button style={{ marginLeft: '10px' }} class="btn btn-info" onClick={() => { props.ModificarEstado(tip.Id) }} startIcon={<MdCancel />} >{tip.Activo ? "Inactivar" : "Activar"}</Button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
...
export default TablaTiposGasto;