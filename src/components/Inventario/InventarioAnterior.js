            ...
            {inventario.length > 0 && (
                <CardContent>
                    <div className="card-body" style={{ textAlign: 'center' }}>
                        <div className="h1 mb-0 font-weight-bold" style={{ textSizeAdjust: "200px" }}>FECHA: {moment(inventario[0].fechaCrea).format("DD-MM-YYYY")}</div>
                    </div>
                    <div className="row">
                        <div className="col-md-6">
                            <div className="row">
                                <div className="card shadow h-100 py-2 mb-4" style={{ borderColor: '#04364A', borderWidth: '3px', marginLeft: '30px', width: '300px', height: '200px' }}>
                                ...
                                <div className="card shadow h-100 py-2 mb-4" style={{ borderColor: '#64CCC5', borderWidth: '3px', marginLeft: '120px', width: '300px', height: '200px' }}>
                            ...
                            <br></br>
                            <div className="row">
                                <div className="card shadow h-100 py-2 mb-4" style={{ borderColor: '#176B87', borderWidth: '3px', marginLeft: '30px', width: '300px', height: '200px' }}>
                                ...
                                <div className="card shadow h-100 py-2 mb-4" style={{ borderColor: '#176B', borderWidth: '3px', marginLeft: '120px', width: '300px', height: '200px' }}>
